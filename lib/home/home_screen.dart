...
final TextStyle styleTitleHome = TextStyle(
    color: Colors.grey,
    fontSize: 13,
    fontWeight: FontWeight.bold
);

final TextStyle styleCountScheduler = TextStyle(
  color: Colors.white,
  fontSize: 28,
  fontWeight: FontWeight.bold
);
          ...
          children: [
            Flexible(
                ...
                child: GestureDetector(
                  ...
                  child: SectionCalender(imgPath: "assets/calendar.png", title: "Today", count: 1, color: Colors.blue)
                )
            ),
            SizedBox(width: 20),
            Flexible(
                flex: 9,
                child: SectionCalender(imgPath: "assets/clock.png", title: "Scheduled", count: 2, color: Colors.amberAccent)
            )
          ],
        ),
        SizedBox(height: 20),
      ...
      builder: (_){
        return Scaffold(
            ...
            floatingActionButton: FloatingActionButton(
              onPressed: () {
                Get.bottomSheet(CreateListScreen());
              },
              child: Text(
                "Add list",style: TextStyle(
                color: Colors.blue,
                fontSize: 18
              ),
              ),
            ...
            body: GestureDetector(
              ...
              child: ListView(
                ...
                children: [
                  SizedBox(
                      height: _.focusNode.hasFocus ? 20 : 0
                  ),
                  SearchBar(controller: _.textController,
                      onTextChange: (x) => _.onTextChange(x), nodeFocus: _.focusNode),
                  SizedBox(height: 20),
                  Obx((){
